        ...
        <View className="flex flex-1 w-screen mx-auto px-8 max-w-md bg-testBgGreen pt-5 mb-32">
          ...
          <View className="items-center">
            ...
            <View className="py-5 w-[350px] rounded px-5 bg-themePaleGreen justify-between">
              <Text className="text-themeNavyBlue font-medium text-3xl pt-2">
                0{" "}
                <Text className="text-xl text-themeNavyBlue font-medium">
                  Derogatory Marks
                </Text>
              </Text>
              <Text className="text-themeWhite mt-2">
                0 collections / 0 public records
              </Text>
              <Text className="text-themeNavyBlue pr-10 text-xs mt-2">
                Derogatory Marks are good to avoid - they can stay on your
