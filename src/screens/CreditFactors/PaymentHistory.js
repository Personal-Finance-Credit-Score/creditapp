        ...
        <View className="flex flex-1 w-screen px-8 max-w-md bg-testBgGreen pt-30 mb-32">
          ...
          <View className="flex-row justify-around mt-5">
            ...
            <View className="flex flex-col justify-end mb-3">
                <Text className="text-themeNavyBlue my-2">Percentage of score</Text>
          ...
          <Text className="text-xl ml-2 text-themeNavyBlue mt-10 mb-3">Your Personal Data Points:</Text>
          ...
          <View className="items-center">
            {/* section 1 */}
            <View
              className="py-5 w-[350px] rounded px-5 flex-row bg-themeGreen justify-between">
            ...
            {/* section 2 */}
            <View
              className="py-5 m-1 w-[350px] px-5 flex-row rounded bg-themeGreen justify-between">
            ...
            {/* section 3 */}
            <View
              className="py-5 w-[350px] px-5 flex-row justify-between rounded bg-themeGreen">
              <Text className="text-themeWhite">Collections</Text>
              <Text className="text-themeWhite">0</Text>
            </View>
            ...
            {/* section 4 */}
            <View
              className="py-5 m-1 w-[350px] px-5 flex-row justify-between rounded bg-themeGreen">
