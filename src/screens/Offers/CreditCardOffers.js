    ...
    <SafeAreaView className="flex-1 min-w-screen min-h-screen bg-themeLightBlue">
      ...
      <ScrollView>
        ...
        <View className="min-h-screen mb-32">
          <View>
            <Text className="font-bold text-themeNavyBlue text-[30px] ml-[25px] mb-3">
              Your Offers
            </Text>
          </View>
          ...
          <View className="px-5">
            ...
            <View className="h-full">
              ...
              <View className="p-2 mb-2 border border-themeClearGray bg-themeWhite">
                ...
                <Text className="font-bold text-themeNavyBlue mt-2 text-[17px]">
                  Wells Fargo
                </Text>
                <View className="flex-1 flex-row mt-[25px] space-x-3">
                  <Image className="self-start ml-[9px]" source={Ava} />
                  <Text className="text-[17px] mr-[20px]">
                    Your chance of approval is{" "}
                    <Text className="font-bold text-themeNavyBlue self-center">
                      good
                    </Text>
                  </Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Reward rate: 2x - 3x per dollar</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Annual fee: $5</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Welcome bonus: 5,000 miles</Text>
                </View>
                ...
                >
                  <Text className="text-themeWhite text-center p-1">
                    View more
                  </Text>
                </TouchableOpacity>
                ...
                >
                  <Text className="text-themeNavyBlue text-center p-1">
                    See details and rates
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <View className="p-2 border border-themeClearGray mb-2 bg-themeWhite">
                ...
                <View className="flex-1 flex-row mt-[25px] space-x-3">
                  ...
                  <Text className="text-[17px] mr-[20px]">
                    Your chance of approval is{" "}
                    <Text className="font-bold text-themeGreen self-center">
                      high
                    </Text>
                  </Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Reward rate: 2x - 5x per dollar</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Annual fee: $95</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Welcome bonus: 75,000 miles</Text>
                </View>
                <TouchableOpacity
                  className="bg-themeNavyBlue mt-5 w-100 h-[50px] justify-center border-2 "
                  onPress={() => {
              ...
              <View className="p-2 mb-2 border border-themeClearGray bg-themeWhite">
                ...
                <View className="flex-1 flex-row mt-[25px] space-x-3">
                  ...
                  <Text className="text-[17px] mr-[20px]">
                    Your chance of approval is{" "}
                    <Text className="font-bold text-orange-400 self-center">
                      fair
                    </Text>
                  </Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Reward rate: 4x per dollar</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Annual fee: $200</Text>
                </View>
                <View className="ml-5 mt-2">
                  <Text>Welcome bonus: 125,000 miles</Text>
                </View>
                <TouchableOpacity
                  className="bg-themeNavyBlue mt-5 w-100 h-[50px] justify-center border-2 "
                  onPress={() => {
